          ...
          <CardContent>
            <div className="relative w-full pt-[56.25%]">
              <iframe
                ...
                src="https://www.youtube.com/embed/pi0PQZFFo4A?si=XH-y5oaPWVkKPQo0"
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row items-center mb-4">
              ...
              <blockquote className="italic text-lg">
                At Jyoti Flooring Works, we&apos;re not just installing floors; we&apos;re laying the foundation for your success. Our commitment to quality, innovation, and customer satisfaction drives everything we do.
              </blockquote>
            </div>
